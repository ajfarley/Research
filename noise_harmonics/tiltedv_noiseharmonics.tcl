...
set runname "noise_highfreq$rsx"
...
pfset Solver.EvapTrans.FileName   "../noise_inputs/noise_input"
...
pfset Geom.domain.ICPressure.FileName                 "/Users/abramfarley/ParF/uahpc/matching_inputs/over0.4freq_hn/initial_pressures/spinup$rsx.out.press.00010.pfb"
...
pfset TopoSlopesX.Geom.left.Value $lsx
pfset TopoSlopesX.Geom.right.Value $rsx
...
pfdist  "/Users/abramfarley/ParF/uahpc/matching_inputs/over0.4freq_hn/initial_pressures/spinup$rsx.out.press.00010.pfb"
...
for {set itime 0} {$itime < 10000 } { incr itime 1} {
  pfdist [format "../noise_inputs/noise_input.%05d.pfb" $itime]}
