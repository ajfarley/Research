...
set runname "tilted_v_layered_highK_sx5"
file mkdir $runname
cd $runname
#---------------------------------------------------------
# Computational Grid
...
pfset Geom.left.Upper.X                        70.0
pfset Geom.left.Upper.Y                        50.0
pfset Geom.left.Upper.Z                        2.5
#was 0.05

#---------------------------------------------------------
# Right Slope Geometry
#---------------------------------------------------------
pfset Geom.right.Lower.X                        80.0
pfset Geom.right.Lower.Y                        0.0
pfset Geom.right.Lower.Z                        0.0

pfset Geom.right.Upper.X                        150.0
pfset Geom.right.Upper.Y                        50.0
pfset Geom.right.Upper.Z                        2.5
#was 0.05
#---------------------------------------------------------
# Channel Geometry
#---------------------------------------------------------
pfset Geom.channel.Lower.X                        70.0
pfset Geom.channel.Lower.Y                        0.0
pfset Geom.channel.Lower.Z                        0.0

pfset Geom.channel.Upper.X                        80.0
pfset Geom.channel.Upper.Y                        50.0
pfset Geom.channel.Upper.Z                        2.5
#was 0.05
...
pfset Geom.domain.Perm.Value           3.6
#1*10-8 m/s  -> m/d
...
pfset TimingInfo.StartCount      0
pfset TimingInfo.StartTime       0.0
pfset TimingInfo.StopTime        4999.0
...
pfset Solver.EvapTrans.FileName   "../layered_inputs/forcing_input_layered"
...
for {set itime 0} {$itime < 5000 } { incr itime 1} {
  pfdist [format "../layered_inputs/forcing_input_layered.%05d.pfb" $itime] }

#for {set i 0} {$i < 199} {incr i 1} {
#    if {($i < 10)} {
#        pfdist "../forcing_input.0000$i.pfb"
#      }
#    elseif {($i < 100)} {
#        pfdist "../forcing_input.000$i.pfb"
#    }
#    elseif {($i < 1000)} {
#        pfdist "../forcing_input.00$i.pfb"
#      }
#}
pfrun $runname
pfundist $runname
