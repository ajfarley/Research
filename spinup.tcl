...
pfset Geom.domain.Perm.Value          5
#3.45*10e-5  -> m/d
...
pfset TimingInfo.DumpInterval    1000
pfset TimeStep.Type              Constant
...
pfset Patch.z-upper.BCPressure.alltime.Value	      -0.010712
#average value from forcing
...
#pfset Solver.EvapTrans.FileName   "../forcing_input/white_noise_input"
...
pfset Geom.domain.ICPressure.Value                      35
...
#  pfdist [format "../forcing_input/white_noise_input.%05d.pfb" $itime] }
